...
#	inputText=request.json["event"]["comment"]["text"]
	inputText=request.json["comment"]
...
#					requests.post(callback,data=responseData)
				...
				if "others" not in classifierResponse:
					...
					reply="1.Initiate a payment via preformat\n2.Authorize payment"
...
run(host='172.31.45.19', port=8545,server='paste')
